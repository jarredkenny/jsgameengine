...
class Scene {
  ...
  render(context){
    ...
    // TODO: Render things only in scene camera.
    if(this.map){
    ...
    // Grab all of the pixels in the scene visible to the camera.
    let visible = this.renderingContext.getImageData(
    ...
    // Render Visible Pixels to the games rendering context.
