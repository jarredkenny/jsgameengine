...
class Game {
  ...
  boot(){
    ...
    let box = new Engine.Entity();
    box.body.position.x = 0;
    box.body.position.y = 100;
    box.body.size.x     = 200;
    box.body.size.y     = 100;
    box.body.mass       = 0;

    let box2 = new Engine.Entity();
    box2.body.position.x = 201;
    box2.body.position.y = 0;
    box2.body.size.x     = 100;
    box2.body.size.y     = 500;
    box2.body.mass       = 0;
